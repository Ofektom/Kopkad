...
async def create_business(
    ...
    *,
    ...
    try:
        ...
        get_cache().clear_pattern("unassigned_businesses:*")
...
async def add_customer_to_business(
    ...
    *,
    ...
    try:
        ...
        get_cache().clear_pattern("businesses:*")
        get_cache().clear_pattern(f"business:{business.id}")
        get_cache().clear_pattern("user_units:*")
        return success_response(
            status_code=200,
            message=message,
            data={
...
async def complete_registration_service(
    ...
    try:
        ...
        if pending_request.unit_id:
            unit_repo.add_member(pending_request.unit_id, pending_request.customer_id)
        ...
        # Invalidate caches
        get_cache().clear_pattern(f"user:{user.id}")
        get_cache().clear_pattern(f"business:{pending_request.business_id}")
        get_cache().clear_pattern("businesses:*")
        get_cache().clear_pattern("user_units:*")
...
async def accept_business_invitation(
    ...
    *,
    ...
    try:
        ...
        # Invalidate caches
        get_cache().clear_pattern(f"user:{pending_request.customer_id}")
        get_cache().clear_pattern(f"business:{pending_request.business_id}")
        get_cache().clear_pattern("businesses:*")
        get_cache().clear_pattern("user_units:*")
        get_cache().clear_pattern("units:*")
...
async def update_business(
    ...
    *,
    ...
    try:
        ...
        get_cache().clear_pattern("businesses:*")
        get_cache().clear_pattern(f"business:{business_id}")
        return success_response(
            status_code=200,
...
async def delete_business(
    ...
    *,
    ...
    try:
        ...
        get_cache().clear_pattern("businesses:*")
        get_cache().clear_pattern("units:*")
        get_cache().clear_pattern("business_summary:*")
        get_cache().clear_pattern("unassigned_businesses:*")
...
async def create_unit(
    ...
    *,
    ...
    try:
        ...
        # Invalidate caches
        get_cache().clear_pattern(f"units:{business_id}")
        get_cache().clear_pattern("unit_summary:*")
        return success_response(
            status_code=201,
...
async def update_business_unit(
    ...
    *,
    ...
    try:
        ...
        # Invalidate caches
        get_cache().clear_pattern(f"unit:{unit_id}")
        get_cache().clear_pattern(f"units:{business_id}")
        return success_response(
            status_code=200,
...
async def delete_unit(
    ...
    *,
    ...
    try:
        ...
        # Invalidate caches
        get_cache().clear_pattern(f"unit:{unit_id}")
        get_cache().clear_pattern(f"units:{unit.business_id}")
        get_cache().clear_pattern("unit_summary:*")
        ...
        session.rollback()
        logger.error(f"Failed to delete unit: {str(e)}")
